...
int main(int argc, char *argv[]) {
	try {
		...
		Observe.YH03_Observe_name = "观测站贰";
		Observe.YH03_Observe_pm2 = 240;
		...
		for (int i = 0; i < 50; ++i) {
			...
			Observe.YH03_Observe_pm2 = 900 * rand() / (RAND_MAX + 1.0)* rand() / (RAND_MAX + 1.0);
			Observe.Yh03_Observe_tem = 0 - 45 + 100 * rand() / (RAND_MAX + 1.0);
