...
#ifndef _TAO_IDL_YH03C_ANWSWI_H_
#define _TAO_IDL_YH03C_ANWSWI_H_
...
namespace YH03
{
  ...
  struct  Observe
  {
    ...
    typedef Observe_var _var_type;
    typedef Observe_out _out_type;
    
    ::CORBA::Long YH03_Observe_ID;
    ::TAO::String_Manager YH03_Observe_name;
    ::CORBA::Double YH03_Observe_pm2;
    ::CORBA::Double Yh03_Observe_tem;
...
TAO_BEGIN_VERSIONED_NAMESPACE_DECL
 ...
 ::CORBA::Boolean operator<< (TAO_OutputCDR &, const YH03::Observe &);
 ::CORBA::Boolean operator>> (TAO_InputCDR &, YH03::Observe &);
