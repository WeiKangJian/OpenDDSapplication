...
#ifndef _TAO_IDL_S02_CHATROOMC_CXB6PI_H_
#define _TAO_IDL_S02_CHATROOMC_CXB6PI_H_
...
namespace S02_ChatRoom
{
  ...
  struct  Message
  {
    ...
    ::TAO::String_Manager MessageInf;
    ::TAO::String_Manager PublisherName;
    ::TAO::String_Manager SendTime;
    ::CORBA::Double Mtime;
  };
...
namespace TAO
{
  ...
  template<>
  class Arg_Traits< ::S02_ChatRoom::Message>
    : public
        Var_Size_Arg_Traits_T<
            ::S02_ChatRoom::Message,
...
TAO_BEGIN_VERSIONED_NAMESPACE_DECL
 ...
 ::CORBA::Boolean operator<< (TAO_OutputCDR &, const S02_ChatRoom::Message &);
 ::CORBA::Boolean operator>> (TAO_InputCDR &, S02_ChatRoom::Message &);
